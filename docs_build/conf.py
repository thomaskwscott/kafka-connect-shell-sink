...
htmlhelp_basename = 'KafkaConnectShellDoc'
...
latex_documents = [
  ('index', 'KafkaConnectShell.tex', u'Kafka Connect Shell Documentation',
   u'3Fi LTD', 'manual'),
]
...
man_pages = [
    ('index', 'kafkaconnectshell', u'Kafka Connect Shell',
     [u'3Fi LTD'], 1)
]
...
texinfo_documents = [
  ('index', 'KafkaConnectShell', u'Kafka Connect Shell Documentation',
   u'3Fi LTD', 'KafkaConnectShell',
